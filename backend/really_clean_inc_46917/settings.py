"""
Django settings for really_clean_inc_46917 project.
...
ROOT_URLCONF = 'really_clean_inc_46917.urls'
...
WSGI_APPLICATION = 'really_clean_inc_46917.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "really_clean_inc_46917 API",
    "DESCRIPTION": "API documentation for really_clean_inc_46917 App",
    "VERSION": "v1",
}
